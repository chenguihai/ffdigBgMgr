...
export default class ViewProduct extends Component {
    ...
    getList = () => {
        const {pid, title, vid} = this.props.location.state || {}
        this.setState({
            pid: pid,
            title: title
        })
        http.get(`api/AdminSite/HomePageAdmin/GetProductByPidVid?pid=${pid}&vid=${vid}`).then(res => {
            this.setState({
                list: res
            })
        })
                ...
                render: (text, record) => {
                    ...
                    return (<div>
                        ...
                        <Row>
                            ...
                            href={`http://www.ffdig.com/detailPage?product=${_id}`} target="_blank" rel="产品详情">{name}</a></Col>
                        </Row>
                        <Row>
                ...
                render: (text, record) => {
                    ...
                    return (
                        <div>
                            ...
                            <Row>
                                <Col className="title" span={SPAN_10}>评价星级</Col><Col span={SPAN_14}>{<Rate
                                style={{fontSize: 12}}
                                disabled
                ...
                >
                    <h3 className="a mt8 mb" onClick={() => {
                        this.props.history.push({
                            ...
                            state: {pid: pid, title: title}
                        });
                    }}><Icon type="left-circle" theme="filled"/>查看栏目</h3>
                    <p className="mt8"><b style={{display: 'inline-block', width: '100px'}}>栏目名称 </b>
                        <span> {title}</span></p>
